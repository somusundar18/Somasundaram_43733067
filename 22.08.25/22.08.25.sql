...
slocation TO location;
select * from employees;

UPDATE employees SET location='india'
WHERE id=1;
select * from employees;

UPDATE employees SET location='india', salary=100000
WHERE  id=3;
ALTER TABLE employees
ADD CONSTRAINT unique_name_dept UNIQUE (name, dept);

SHOW INDEX FROM employees;

ALTER TABLE employees
DROP INDEX unique_name_dept;